...
# sphinx-quickstart on Thu Jun  1 22:04:54 2017.
#
...
# Make sure we have all necessary modules
try:
    import numpydoc
except ImportError:
...
project = u'MbKit'
copyright = u'2017, Felix Simkovic'
author = u'Felix Simkovic'
...
latex_documents = [
    (master_doc, 'MbKit.tex', u'MbKit Documentation',
     u'Felix Simkovic', 'manual'),
]
